...
<body>
<div class="text">
<button onclick="window.print()">Print Ahmad Lubbadeh’s Resume</button>
<p id="demo"></p>
</div>
<h1 onclick="myFunction()">Ahmad Lubbadeh</h1>
...
<br>
<img src="jerusalem.jpg" alt="Jerusalem city"style="max-width:100%;" width="600" height="400">
<br>
...
function myFunction()
{
window.alert('Welcome to Ahmad Lubbadeh site, please let me know if you have any questions');
}
</script>
</body>
</html>
